...
#recodifico q62 en dos categorías (LA CATEGORÍA "PREFIERO NO RESPONDER QUEDA DENTRO DE SÍ")

enma<-enma %>% 
  mutate(q62_new=case_when(q62_discriminacion=="Sí, frecuentemente" | q62_discriminacion=="Sí, alguna vez" | q62_discriminacion=="Prefiero no responder"~ "Al menos alguna vez",
...
enma<-enma %>% 
  mutate(q64_new=case_when(q64_violencia_fuerza_seguridad=="No, nunca" ~ "No, nunca",
                           q64_violencia_fuerza_seguridad=="Sí, alguna vez" | q64_violencia_fuerza_seguridad=="Sí, frecuentemente" | q64_violencia_fuerza_seguridad=="Prefiero no responder"~ "Al menos alguna vez",
                           TRUE ~ NA))
...
#resultados
pedido17_q62<- enma %>%
  filter(q62_new=="Al menos alguna vez" | q62_new=="No, nunca") %>% 
  group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
...
pedido17_q63_v2a <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_estado==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2b <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_fuerzas==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2c <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_atencion_medica==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2d <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_educacion==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2e <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_calle==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2f <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_trabajo==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2g <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_grupos_sociales==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2h <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_transporte==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2i <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_medios_comunicacion==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
pedido17_q63_v2j <- enma %>%
  filter((q62_new=="Al menos alguna vez" | q62_new=="No, nunca") & q63_discriminacion_otros==1) %>% 
  #group_by(q62_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
...
#resultados
pedido17_q64 <- enma %>%
  filter(q64_new=="Al menos alguna vez" | q64_new=="No, nunca") %>% 
  group_by(q64_new) %>% 
  summarise(Poblacion= sum(weightvec),
            Indigena  = sum(weightvec[q5_descendencia_indigena==1]),
            Afro = sum(weightvec[q5_descendencia_afro == 1]),
