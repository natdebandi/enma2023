...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="univariado_agrup",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_edad), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="edad",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_edad10), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="edad_10",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_edadv2), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="edadv2",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_tiempores), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="tiempo_res",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_migrec), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="migracion_rec",append = TRUE)

nivel_ed<-enma %>% 
  group_by(q46_estudios, niveled) %>% 
  summarise(cantidad=sum(weightvec)) %>% 
  pivot_wider(names_from = niveled, values_from = cantidad)


enma<- enma %>% 
  mutate(niveled=case_when(q46_estudios=="Primario completo" | q46_estudios=="Secundario incompleto o en curso" | q46_estudios=="Primario incompleto o en curso"~ "Bajo",
                           q46_estudios=="Secundario completo" | q46_estudios=="Terciario incompleto o en curso" | q46_estudios=="Universitario incompleto o en curso" ~ "Medio",
                           q46_estudios=="Terciario completo" | q46_estudios=="Universitario completo" ~ "Alto",
                           TRUE ~ NA))
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_niveled), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="nivel_ed",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_seccomp), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="sec_comp", append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_region), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="region",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_MERCOSUR), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="MERCOSUR",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_nacionalidad), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="nacionalidad",append = TRUE)
...
#guardo tabulado
write.xlsx2(as.data.frame(pedido59_dni), "tables/5.Socioeconómica/cuadros_pedido59_v2.xlsx", row.names = FALSE, sheetName ="dni",append = TRUE)
