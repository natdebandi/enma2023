...
write.xlsx2(as.data.frame(consulta_w), "cuadros/sociodemograficos.xls", row.names = FALSE, sheetName ="nacionalidades_pond",append = TRUE)
...
write.xlsx2(as.data.frame(consulta_w), "cuadros/sociodemograficos.xls", row.names = FALSE, sheetName ="genero",append = TRUE)
```
...
consulta
#exporto el csv
write.xlsx2(as.data.frame(consulta), "cuadros/familias.xlsx", row.names = FALSE, sheetName = "nacionalidad",append = TRUE) 
...
write.xlsx2(as.data.frame(consulta), "cuadros/familias.xlsx", row.names = FALSE, sheetName = "resumen",append = TRUE) 
