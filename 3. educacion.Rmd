...
Grafico_3.9<-enma %>% 
  ...
  group_by(region_amba_var) %>%
  summarise(Total=round(sum(weightvec),0),
            Total_si=round(sum(weightvec[q47_estudiando_argentina=="Si"]),0),
...
Grafico_3.10<-enma %>% 
  ...
  summarise(Total=round(sum(weightvec_0),0),
            Total_si=round(sum(weightvec_0[q47_estudiando_argentina=="Si"]),0),
            Total_no=round(sum(weightvec_0[q47_estudiando_argentina=="No"]),0),
            Porcentaje_si=round(Total_si/Total*100,1),
            Porcentaje_no=round(Total_no/Total*100,1))
